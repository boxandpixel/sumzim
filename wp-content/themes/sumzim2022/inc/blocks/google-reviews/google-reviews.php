    ...
    <div class="contain">
        <div class="google-reviews__carousel" id="<?php echo esc_attr($carousel_id); ?>" data-total="<?php echo count($reviews); ?>">
            ...
            <div class="google-reviews__navigation">
                <button class="google-reviews__nav-btn google-reviews__nav-btn--prev" aria-label="Previous review">
                ...
                <button class="google-reviews__nav-btn google-reviews__nav-btn--next" aria-label="Next review">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
