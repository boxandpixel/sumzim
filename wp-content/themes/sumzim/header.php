...
<link rel="preload"
      as="style"
      href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200&icon_names=360,add,arrow_back,arrow_forward,attach_money,award_star,calendar_month,check,check_circle,chevron_left,chevron_right,close,collapse_content,design_services,east,electric_bolt,exclamation,expand_content,expand_less,expand_more,format_quote,frame_exclamation,handshake,heat,hvac,keyboard_arrow_up,lightbulb_2,menu,mode_fan,open_in_new,pace,remove,safety_check,school,search,sentiment_dissatisfied,sentiment_satisfied,shield_with_house,star,task_alt,valve,water_drop&display=swap" />
<link rel="stylesheet"
      href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200&icon_names=360,add,arrow_back,arrow_forward,attach_money,award_star,calendar_month,check,check_circle,chevron_left,chevron_right,close,collapse_content,design_services,east,electric_bolt,exclamation,expand_content,expand_less,expand_more,format_quote,frame_exclamation,handshake,heat,hvac,keyboard_arrow_up,lightbulb_2,menu,mode_fan,open_in_new,pace,remove,safety_check,school,search,sentiment_dissatisfied,sentiment_satisfied,shield_with_house,star,task_alt,valve,water_drop&display=swap"
      media="print" onload="this.media='all'" />
<noscript>
  <link rel="stylesheet"
        href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200&icon_names=360,add,arrow_back,arrow_forward,attach_money,award_star,calendar_month,check,check_circle,chevron_left,chevron_right,close,collapse_content,design_services,east,electric_bolt,exclamation,expand_content,expand_less,expand_more,format_quote,frame_exclamation,handshake,heat,hvac,keyboard_arrow_up,lightbulb_2,menu,mode_fan,open_in_new,pace,remove,safety_check,search,school,sentiment_dissatisfied,sentiment_satisfied,shield_with_house,star,task_alt,valve,water_drop&display=swap" />
</noscript>
