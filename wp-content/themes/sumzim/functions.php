<?php
/**
 * Summers & Zim\'s functions and definitions
 *
...
function sumzim_setup() {
	/*
		...
		* If you're building a theme based on Summers & Zim\'s, use a find and replace
...
function sumzim_scripts() {
	wp_enqueue_style( 'sumzim-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'sumzim-style', 'rtl', 'replace' );

	wp_enqueue_script( 'sumzim-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
